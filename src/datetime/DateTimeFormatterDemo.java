...
public class DateTimeFormatterDemo {
    public static void main(String[] args) {
         ...
         * */
        DateTimeFormatter ownPattern = DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mmx");
        System.out.println("Own pattern: "+ownPattern.format(zDate));

        System.out.println("*************parse()**************");
        String charsPattern = "09.07.1988 18:34-04";
        ...
        /*
         * Есть методы для взаимодействия с GregorinaCalendar -> ZoneDateTime
         * */
